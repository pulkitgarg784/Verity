export class HeadlineManager {
  constructor() {
    this.realHeadlines = [
      ...
      { text: "White House seeks corporate sponsorships for Easter event",
        link: "https://www.cnn.com/2025/03/23/politics/white-house-easter-egg-roll-corporate-sponsorships/index.html"
      },
      {
        text: "School district bans candy bribes used to lure kids to Bible classes",
        link: "https://www.friendlyatheist.com/p/columbus-school-district-bans-candy"
      },
      {
        text: "Salvation Army is asking people to donate less amid tariff dispute",
        link: "https://www.ctvnews.ca/atlantic/article/salvation-army-is-asking-people-to-donate-less-amid-tariff-dispute/"
      }
    ];
